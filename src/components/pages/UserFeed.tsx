...
export default function UserFeed(): React.JSX.Element {
  ...
  const handleToggleSave = (whisperId: number) => {
    if (savedWhisperIds.includes(whisperId)) {
      // Eğer zaten kaydedilmişse listeden çıkar (Kaydetmeyi iptal et)
      setSavedWhisperIds(savedWhisperIds.filter(id => id !== whisperId));
    } else {
      // Kaydedilmemişse listeye ekle
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        {currentTab === 'feed' ? (
              ...
              return (
                <div 
                  ...
                  style={{ 
                    ...
                    gap: '16px',
                    position: 'relative' // Sağ üstteki butonu hizalamak için önemli
                  }}
                >
                  {/* Üst Kısım: Profil ve Sağ Üst Kaydet Butonu sarmalı */}
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        alignItems: 'center',
                        transition: 'all 0.2s',
                        color: isSaved ? '#4F46E5' : '#9CA3AF', // Kaydedilince Fısıltı Moru olur
                    ...
                    >
                      <FiBookmark style={{ 
                        fontSize: '18px', 
                        fill: isSaved ? '#4F46E5' : 'transparent' // İçini doldurma efekti
                      }} />
                    </button>
          ...
          <div style={{ width: '100%', maxWidth: '680px', backgroundColor: '#FFFFFF', padding: '40px', borderRadius: '24px', border: '1px solid #E5E7EB', textAlign: 'center' }}>
            <h2 style={{ margin: 0, color: 'black' }}>Profilim</h2>
          </div>
        )}
